...
// the function below is a helper function to use with the functions that need to be compatible with an array or object
// it checks if input is an array, and if so, returns a copy of it;
// if not, it uses JS' object.values method to return an array that contains the values of the object's properties
